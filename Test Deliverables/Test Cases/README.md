...
6|  TTest if the todo items can be updated with an empty text field   | Click the update button without entering any information to the Update Value text area.  | The todo items should not be updated without entering information in the Update Value text area an error message should be displayed requesting or telling the user to add information.| The application can submit and update empty fields. | Fail| Yes
